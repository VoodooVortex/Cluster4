        ...
        <form class="w-full max-w-3xl bg-white p-6 rounded-lg shadow-lg">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-6 flex items-center justify-between">
                    <a href="{{ url('/') }}">
                        <button class="rounded-md bg-gray-300 px-3 py-2 text-sm font-semibold text-black hover:bg-medium gray-500 focus:outline-none focus:ring-2 focus:ring-medium gray-600">
                            ยกเลิก
                        </button>
                    </a>
