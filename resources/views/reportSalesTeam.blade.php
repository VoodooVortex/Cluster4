{{--
    @title : ดูรายงานสาขาของพนักงาน Sales Supervisor
...
@if ($userRole == "CEO")
    <div class="pt-16 bg-white-100 w-full">
        ...
        {{-- ช่องค้นหา --}}
        <form method="GET" action="{{ route('reportSalesTeam') }}">
        ...
        <form method="GET" action="{{ route('reportSalesTeam') }}" class="mb-4 flex gap-2 justify-start px-4">
            <div class="relative w-full">
                <select name="province" id="provinceSelect" onchange="this.form.submit()"
                    ...
                    <option value="นครราชสีมา" {{ request('province') == 'นครราชสีมา' ? 'selected' : '' }}>นครราชสีมา</option>
            ...
            @foreach ($paginatedBranches as $branch)
                <div class="bg-white rounded-md p-4 mb-4 border-2 border-gray-300 mx-4 ">
                    ...
                    <div class="flex items-center mt-1">
                        <img src="$branch->manager->profile_image ?? '/images/default-user.png' }}" alt="Photo User" class="w-12 h-12 rounded-full mr-3 ">
                        <div>
